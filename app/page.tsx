                    ...
                    <div className="lg:col-span-5 bg-zinc-950/40 border border-white/5 p-5 rounded-2xl flex flex-col gap-4">
                      ...
                      <div className="space-y-3">
                        ...
                        <button
                          ...
                          onClick={() => {
                            if (!wizTitle.trim()) {
                              setWizError("Please enter a liability name.");
                              return;
                            }
                            const amt = parseFloat(wizAmount);
                            if (isNaN(amt) || amt <= 0) {
                      ...
                      <div className="lg:col-span-6 space-y-4">
                        <div className="bg-zinc-950/40 border border-white/5 p-4 rounded-2xl space-y-3">
                          <h4 className="text-xs font-bold font-mono text-zinc-400 uppercase tracking-wider">
                            Configure Recurring Savings Target
                          </h4>
                          <p className="text-[11px] text-zinc-400 leading-relaxed">
                            Enter an amount and frequency to commit to savings.
                            This will be automatically reflected as an outgoing
                            savings allocation.
                          </p>
                          ...
                          <div className="flex items-center gap-3 mt-1.5">
                            <label className="flex items-center gap-2 text-xs font-bold text-white cursor-pointer select-none">
                              <input
                                ...
                                onChange={(e) =>
                                  setWizSavingsEnabled(e.target.checked)
                                }
                          ...
                          {wizSavingsEnabled && (
                            ...
                            >
                              <div className="flex flex-col gap-1.5">
                                <label className="text-[10px] font-bold font-mono tracking-wider text-zinc-500 uppercase">
                                  Savings Name
                                </label>
                                <input
                                  type="text"
                                  ...
                                  onChange={(e) =>
                                    setWizSavingsTitle(e.target.value)
                                  }
                                  className="bg-zinc-900 border border-white/10 rounded-xl px-3 py-2 text-xs text-white focus:outline-none focus:border-indigo-500 font-medium"
                                />
                              </div>
                              ...
                              <div className="flex flex-col gap-1.5">
                                ...
                                <input
                                  ...
                                  onChange={(e) =>
                                    setWizSavingsAmount(e.target.value)
                                  }
                                  className="bg-zinc-900 border border-white/10 rounded-xl px-3 py-2 text-xs text-white focus:outline-none focus:border-indigo-500 font-mono font-medium"
                                />
                              </div>
                              ...
                              <div className="flex flex-col gap-1.5 sm:col-span-2">
                                ...
                                <select
                                  ...
                                  onChange={(e) =>
                                    setWizSavingsFrequency(e.target.value)
                                  }
          ...
          <AnimatePresence mode="wait">
                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 bg-zinc-900/30 p-5 border border-white/5 rounded-3xl">
                  <div>
                    ...
                    <p className="text-xs text-zinc-500">
                      Center your cash timeline projection by picking starting
                      metrics.
                    </p>
                  </div>
                  ...
                  <div className="flex flex-wrap items-center gap-5">
                    <div className="flex flex-col gap-1">
                      <span className="text-xs font-semibold font-mono tracking-wider text-zinc-300 uppercase">
                        Starting Balance
                      </span>
                      <div className="flex items-center gap-1.5">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3.5">
                  ...
                  <div className="bg-zinc-900/50 border border-white/10 rounded-2xl p-4 flex flex-col justify-between hover:bg-zinc-900/70 transition-colors">
                    <div>
                      ...
                      <h3 className="text-xl md:text-2xl font-bold mt-1 text-white">
                        $
                        {activeMetrics.income.toLocaleString("en-US", {
                          minimumFractionDigits: 2,
                        })}
                      </h3>
                    </div>
                  ...
                  <div className="bg-zinc-900/50 border border-white/10 rounded-2xl p-4 flex flex-col justify-between hover:bg-zinc-900/70 transition-colors">
                    <div>
                      ...
                      <h3 className="text-xl md:text-2xl font-bold mt-1 text-white">
                        $
                        {activeMetrics.expenses.toLocaleString("en-US", {
                          minimumFractionDigits: 2,
                        })}
                      </h3>
                    </div>
                  ...
                  <div className="bg-zinc-900/50 border border-white/10 rounded-2xl p-4 flex flex-col justify-between hover:bg-zinc-900/70 transition-colors">
                    <div>
                      ...
                      <h3 className="text-xl md:text-2xl font-bold mt-1 text-white">
                        $
                        {activeMetrics.savings.toLocaleString("en-US", {
                          minimumFractionDigits: 2,
                        })}
                      </h3>
                    </div>
                  ...
                  <div className="bg-zinc-900/50 border border-white/10 rounded-2xl p-4 flex flex-col justify-between hover:bg-zinc-900/70 transition-colors">
                    <div>
                      ...
                      <h3 className="text-xl md:text-2xl font-bold mt-1 text-white">
                        $
                        {activeMetrics.liabilities.toLocaleString("en-US", {
                          minimumFractionDigits: 2,
                        })}
                      </h3>
                    </div>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                      ...
                      <p className="text-xs text-zinc-300 font-medium">
                        {forecastRange === "week" &&
                          "Showing detailed 7-day layout for this week (Monday to Sunday)."}
                        {forecastRange === "two-weeks" &&
                          "Showing detailed 7-day layout for next week (Monday to Sunday)."}
                        {forecastRange === "month" &&
                          `Month layout for ${calendarMonthLabel}. Navigate months below.`}
                        {forecastRange === "quarter" &&
                          "Quarter View: Full 90-day trajectory."}
                      </p>
                    </div>
                  ...
                  {(forecastRange === "week" ||
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-7 gap-3 mt-2">
                      {forecastTimeline.map((day, idx) => {
                        ...
                        const hasIncome = day.transactions.some(
                          (t) => t.item.category === "income",
                        );
                        const hasExpense = day.transactions.some(
                          (t) =>
                            t.item.category === "fixed-expense" ||
                            t.item.category === "subscription",
                        );
                        const hasSavings = day.transactions.some(
                          (t) => t.item.category === "savings",
                        );
                        const hasLiability = day.transactions.some(
                          ...
                          return (
                            ...
                            >
                              <div className="flex items-center justify-between w-full">
                                <span
                                  className={`text-xs font-mono font-bold ${isLaunchDay ? "text-indigo-400" : "text-zinc-200"}`}
                                >
                                  {dayNum}
                                </span>
                                {isLaunchDay && (
                              ...
                              {dForecast ? (
                                <div className="flex flex-col gap-0.5 mt-auto">
                                  ...
                                  <div className="flex gap-1 h-1 mt-1 overflow-hidden">
                                    ...
                                    {hasExpense && (
                                      <span
                                        className="w-1 h-1 rounded-full bg-sky-400 shrink-0"
                                        title="Expense"
                                      ></span>
                                    )}
                                    {hasLiability && (
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/5 pb-4">
                  <div>
                    ...
                    <p className="text-xs text-zinc-500">
                      Manage checking, savings, and card parameters to track
                      starting liquidity and routing.
                    </p>
                  </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                  ...
                  <div className="lg:col-span-5 bg-zinc-950/40 border border-white/10 rounded-3xl p-5 space-y-4">
                    ...
                    {accFormError && (
                      <div className="p-3 bg-amber-500/10 border border-amber-500/20 text-amber-300 text-xs rounded-xl flex justify-between items-center">
                    ...
                    {accounts.length === 0 ? (
                      <div className="flex flex-col items-center justify-center py-16 bg-zinc-900/15 border border-dashed border-white/5 rounded-3xl text-center">
                        ...
                        <p className="text-xs text-zinc-500 max-w-xs mt-1">
                          Add a checking or savings account above to establish
                          your asset bases and starting projection balances.
                        </p>
                      </div>
                    ) : (
                            ...
                            >
                                  ...
                                  {linkedLiability ? (
                                    ...
                                    <div className="p-2 bg-amber-500/5 border border-amber-500/10 rounded-xl flex flex-col gap-1">
                                      ...
                                      <span className="text-[9px] text-zinc-400">
                                        No scheduled payment found in
                                        liabilities. Add one to keep your
                                        forecast precise.
                                      </span>
                                    </div>
                                  )}
                              ...
                              <div className="flex gap-3 justify-end mt-4 pt-3.5 border-t border-white/5 opacity-80 group-hover:opacity-100 transition-opacity">
                                ...
                                <button
                                        ...
                                        const updatedTxs = transactions
                                          ...
                                          .map((t) => {
                                            ...
                                            if (t.accountId === acc.id) {
                                              newT.accountId = undefined;
                                            }
                                            if (t.fundingAccountId === acc.id) {
                                              newT.fundingAccountId = undefined;
                                            }
                                            return newT;
                                          });
                                  ...
                                  className="text-[10px] font-bold font-mono uppercase text-amber-400 hover:text-amber-300 transition-colors font-bold"
                                >
                                  Delete
                                </button>
                              </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/5 pb-4">
                  <div>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                      <p className="text-xs text-zinc-500">
                        Register and edit your recurring paychecks, salaries, or
                ...
                {categorizedTransactions.income.length === 0 ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {categorizedTransactions.income.map((tx) => (
                      <div
                        key={tx.id}
                        className="bg-zinc-900/50 border border-white/10 rounded-2xl p-5 flex flex-col justify-between hover:border-zinc-700 transition-colors"
                      >
                        <div className="flex items-start justify-between">
                          ...
                          <div className="text-right">
                            ...
                            <span className="text-[10px] font-mono font-semibold text-zinc-400 block mt-0.5">
                        ...
                        <div className="flex items-center justify-between mt-4 pt-4 border-t border-white/10">
                          ...
                          <div className="flex gap-2">
                            ...
                            <button
                              ...
                              className="text-xs font-bold px-3 py-1 bg-zinc-800/80 hover:bg-zinc-700 text-zinc-300 hover:text-white rounded-lg transition-colors border border-white/10"
                            >
                              Remove
                            </button>
                          </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/10 pb-4">
                  <div>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-3 mt-1">
                      <p className="text-xs text-zinc-300 font-medium">
                        Log and configure regular fixed expenses, digital
                        subscriptions, or automated safety savings.
                      </p>
                      ...
                      {categorizedTransactions.fixedExpenses.length === 0 ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          {categorizedTransactions.fixedExpenses.map((tx) => (
                            <div
                              key={tx.id}
                              className="bg-zinc-900/50 border border-white/10 rounded-2xl p-4.5 flex flex-col justify-between"
                            >
                              <div className="flex items-start justify-between">
                                <div>
                                  <h4 className="text-base font-bold text-white">
                              ...
                              {tx.notes && (
                                <p className="text-xs text-zinc-300 mt-2 bg-black/40 p-2.5 rounded-xl border border-white/10">
                                  {tx.notes}
                                </p>
                              )}
                              <div className="flex items-center justify-between mt-3 pt-3 border-t border-white/10">
                                ...
                                <div className="flex gap-2">
                                  <button
                                    onClick={() => handleEditTransaction(tx)}
                                    className="text-xs font-bold px-2.5 py-1 bg-zinc-800 hover:bg-zinc-700 rounded-lg text-zinc-200 hover:text-white transition-colors"
                                  >
                                    Modify
                                  </button>
                                  <button
                                    ...
                                    className="text-xs font-bold px-2.5 py-1 bg-zinc-800/80 hover:bg-zinc-700 text-zinc-300 hover:text-white rounded-lg transition-colors border border-white/10"
                                  >
                                    Terminate
                                  </button>
                                </div>
            ...
            {activeTab === "liabilities" && (
              ...
              >
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-white/10 pb-4">
                  <div>
                    ...
                    <p className="text-xs text-zinc-300 font-medium mt-1">
                      Monitor interest rates, credit limits, daily interest accrual, and plan payoff strategies.
                    </p>
                  </div>
                ...
                {/* Aggregated Debt Summary Ribbon */}
                {categorizedTransactions.liabilities.length > 0 && (
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 p-4 bg-zinc-900/60 border border-white/10 rounded-2xl">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-[10px] font-mono text-zinc-400 uppercase">Total Debt Owed</div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-base font-bold font-mono text-zinc-200">
                          {(() => {
                            const debts = categorizedTransactions.liabilities.filter((t) => (t.currentBalance || 0) > 0);
                            if (debts.length === 0) return "0.0%";
                            const totalBal = debts.reduce((acc, t) => acc + (t.currentBalance || 0), 0);
                            if (totalBal === 0) return "0.0%";
                            const weightedApr = debts.reduce((acc, t) => acc + (t.currentBalance || 0) * (t.interestRate || 0), 0) / totalBal;
                ...
                {categorizedTransactions.liabilities.length === 0 ? (
                  <div className="flex flex-col items-center justify-center py-16 bg-zinc-900/20 border border-dashed border-white/10 rounded-3xl text-center">
                    ...
                    <p className="text-xs text-zinc-300 max-w-xs mt-1">
                      Track credit cards, auto loans, mortgages, or personal debts with interest accrual and payoff timelines.
                    </p>
                  </div>
                ) : (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {categorizedTransactions.liabilities.map((tx) => {
                      ...
                      return (
                        <div
                          key={tx.id}
                          className={`bg-zinc-900/60 border rounded-2xl p-5 flex flex-col justify-between hover:border-zinc-700 transition-colors ${
                            isPaidOff
                        ...
                        >
                          <div>
                            ...
                            <div className="flex items-start justify-between gap-2">
                              ...
                              {/* Payoff Status Badge */}
                              {isPaidOff ? (
                                <span className="text-[10px] font-mono font-bold text-emerald-400 bg-emerald-500/15 border border-emerald-500/30 px-2.5 py-1 rounded-lg flex items-center gap-1">
                                  <CheckCircle2 className="w-3 h-3" />
                                  PAID OFF
                                </span>
                              ) : details.monthsToPayoff !== null ? (
                                <span className="text-[10px] font-mono font-bold text-amber-300 bg-amber-500/10 border border-amber-500/20 px-2.5 py-1 rounded-lg">
                                  Payoff: {details.payoffDateStr}
                                </span>
                              ) : (
                                <span className="text-[10px] font-mono font-bold text-rose-400 bg-rose-500/15 border border-rose-500/30 px-2 py-1 rounded-lg">
                                  Negative Amort.
                                </span>
                              )}
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-3 mt-4 p-3 bg-black/40 rounded-xl border border-white/5">
                              <div>
                                <div className="text-[10px] font-mono text-zinc-400">Current Owed</div>
                                <div className="text-base font-bold font-mono text-white">
                                  ${bal.toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                                </div>
                                {tx.startingBalance && tx.startingBalance > bal && (
                                  <div className="text-[10px] text-zinc-400 font-mono">
                                    Orig: ${tx.startingBalance.toLocaleString("en-US")}
                                  </div>
                                )}
                              </div>

                              <div>
                                <div className="text-[10px] font-mono text-zinc-400">Monthly Payment</div>
                                <div className="text-base font-bold font-mono text-amber-400">
                                  ${tx.amount.toLocaleString("en-US", { minimumFractionDigits: 2 })}
                                </div>
                                {tx.minimumPayment && tx.minimumPayment > 0 && (
                                  <div className="text-[10px] text-zinc-400 font-mono">
                                    Min: ${tx.minimumPayment.toLocaleString("en-US")}
                                  </div>
                                )}
                              </div>
                            </div>

                            {/* Credit Utilization Bar (if credit card or revolving LOC with limit) */}
                            {limit > 0 && (
                              <div className="mt-3 space-y-1">
                                <div className="flex justify-between text-[10px] font-mono">
                                  ...
                                  <span className={`font-bold ${
                                    ...
                                    ${bal.toLocaleString("en-US")} / ${limit.toLocaleString("en-US")} ({utilization}%)
                                  </span>
                                </div>
                            ...
                            {/* Interest Metrics & Volume Details */}
                            {tx.interestRate !== undefined && tx.interestRate > 0 && !isPaidOff && (
                              <div className="mt-3 text-xs space-y-1 bg-amber-950/10 p-2.5 rounded-xl border border-amber-500/15">
                                ...
                                <div className="flex justify-between text-zinc-300">
                                  ...
                                  <span className="font-mono text-zinc-200">${details.dailyInterestAccrual.toFixed(2)} / day</span>
                                </div>
                                <div className="flex justify-between text-zinc-300">
                                  <span>Monthly Interest Volume:</span>
                                  <span className="font-mono text-zinc-200">${details.monthlyInterestAccrual.toFixed(2)} / mo</span>
                                </div>
                                {details.monthsToPayoff !== null && (
                                  <div className="flex justify-between text-zinc-300 pt-1 border-t border-amber-500/10">
                                    <span>Total Est. Interest Cost:</span>
                                    <span className="font-mono font-bold text-amber-300">
                                      ${details.totalInterestPaid.toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                                    </span>
                                  </div>
                                )}
                              </div>
                                  ...
                                  <div className="space-y-1.5 pt-2 border-t border-amber-500/15 text-zinc-300">
                                    {details.monthsToPayoff !== null ? (
                                      ...
                                      <div className="p-2.5 rounded-xl bg-rose-500/10 border border-rose-500/30 text-rose-300 text-[11px] flex items-center gap-2">
                                        ...
                                        <span>
                                          Scheduled payment (${pmt.toFixed(2)}) is less than or equal to monthly interest (${details.monthlyInterestAccrual.toFixed(2)}). The debt will not pay down!
                                        </span>
                                      </div>
                                    )}
                                  </div>
                ...
                {selectedDay.transactions.length === 0 ? (
                  ...
                  <div className="flex flex-col gap-2">
                    {selectedDay.transactions.map((t, idx) => (
                      <div
                        key={idx}
                        className="flex items-center justify-between p-3 rounded-2xl bg-black/20 border border-white/5"
                      >
                        <div className="flex items-center gap-3">
                          <span
            ...
            >
              ...
              <div className="p-6 space-y-6 overflow-y-auto max-h-[75vh]">
                {(() => {
                  ...
                  const baselineSim = simulateDebtPayoff(liabilities, 0, "avalanche");
                  const activeSim = simulateDebtPayoff(liabilities, payoffExtraBudget, payoffStrategy);
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 p-4 bg-gradient-to-r from-amber-950/30 via-zinc-900 to-amber-950/30 border border-amber-500/30 rounded-2xl">
                        <div className="space-y-1">
                          <div className="text-[10px] font-mono text-zinc-400 uppercase">Est. Debt-Free Target</div>
                          <div className="text-base font-bold font-mono text-emerald-400">
                            {activeSim.debtFreeDateStr}
                          </div>
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-[10px] font-mono text-zinc-400">
                            {activeSim.payoffOrder.length} Debts Simulated
                          </span>
                        </div>
